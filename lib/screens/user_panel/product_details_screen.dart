...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        iconTheme: IconThemeData(color: AppConstant.appMainColor),
    ...
    itemBuilder: (context, index) {
      ...
      ReviewModel reviewModel= ReviewModel(customerName:data["customerName"] ,
          customerPhone: data["customerPhone"], customerDeviceToken: data["customerDeviceToken"], customerId: data["customerId"], feedback: data["feedback"], rating: data["rating"], createdAt: data["createdAt"]);
  ...
  Future<void> checkProductExistence(
    ...
    final DocumentReference documentReference = FirebaseFirestore.instance
        .collection("cart").doc(uId).collection("cartOrders").doc(
